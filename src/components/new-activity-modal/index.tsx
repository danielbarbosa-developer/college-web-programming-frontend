        ...
        >
            <Container>
                ...
                <form onSubmit={onSubmit}>
                    ...
                    {errors.courseUnitId && <Error>O prenchimento do campo Ã© obrigatÃ³rio</Error>}
                    <input
                        type="text"
                        placeholder="Atividade"
                        {...register("name")}
                    />
                    {errors.name && <Error>O prenchimento do campo Ã© obrigatÃ³rio</Error>}
                    <input
                        type="number"
                        step=".01"
                        placeholder="Nota da avaliaÃ§Ã£o"
                        {...register("grade")}
                    />
                    {errors.grade && <Error>O prenchimento do campo Ã© obrigatÃ³rio</Error>}
                    <input
                        type="date"
                        placeholder="Data da atividade"
                        {...register("activy_date")}
                    />
                    {errors.activy_date && <Error>O prenchimento do campo Ã© obrigatÃ³rio</Error>}
                    <button type="submit">
                        Cadastrar
                    </button>
                </form>
